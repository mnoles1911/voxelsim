...
2026-09-09 | UI | Map and player screens under the shell ScaleBox, measured at 2560x1440 (VoxelScreen00031/00032): body panel spans x 597..1962 = 1366 px on both, the same as the fixed journal -> factor exactly 1.0; nothing is being shrunk. Item closed without a code change. | **CLOSED** | - |
2026-09-10 | LOADING | First-recompute split landed and gated: leg 12 seg=LOADING hitches=7 p99 20.8 ms max 1093 ms (was 15 / 20.6 / 5328), READY 16.7 s with 60,250 tracked (was 14.1 s / 56,235), final world identical (71,517 jobs, 71,565 records). Legs 10-11 refuted a global dispatch hold and an early gate on the way. | **LANDED** | remaining 1.1 s frame |
