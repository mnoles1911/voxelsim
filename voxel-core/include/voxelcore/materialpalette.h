...
inline constexpr MaterialAppearance kMaterialPalette[kMaterialCount] = {
    ...
    /* MAT_LEAF_BROADLEAF */ {{{78, 120, 54}, {72, 111, 50}, {62, 96, 44}}, 46, 40, 68, 12, 0},
    /* MAT_LEAF_NEEDLE */ {{{54, 88, 64}, {50, 82, 59}, {43, 71, 51}}, 44, 32, 62, 12, 0},
    /* MAT_LEAF_JUNGLE */ {{{58, 112, 50}, {53, 103, 46}, {45, 88, 39}}, 48, 42, 70, 14, 0},
    /* MAT_LEAF_DRY */ {{{142, 134, 82}, {134, 126, 77}, {118, 111, 68}}, 46, 36, 64, 12, 0},
    /* MAT_BARK_PALE */ {{{176, 168, 152}, {198, 194, 181}, {176, 168, 152}}, 26, 10, 44, 12, 0},
    /* MAT_LEAF_BLOSSOM */ {{{234, 190, 200}, {228, 182, 193}, {214, 168, 180}}, 34, 30, 50, 12, 0},
    /* MAT_LEAF_AUTUMN */ {{{192, 118, 50}, {184, 112, 47}, {168, 101, 42}}, 50, 48, 68, 12, 0},
