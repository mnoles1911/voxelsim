...
| `cond_snr` | `[0.3, 0.1, 1.0, 0.1, 1.0]` | Per channel, how tightly the coarse model must obey the sketch. Elevation at 0.3 is loose — the model has real freedom to reinterpret a supplied heightmap. Raise it if hand-drawn coastlines are being ignored. | read (`world_pipeline.py:353,965`) |
