...
// ---------------------------------------------------------------------------
DECLARE_GPU_STAT_NAMED(VoxelStreamPoolUpload, TEXT("VoxelStreamPoolUpload"));
                                                      ...
                                                      TArray<FPendingGpuHide>&& Hides)
{
		 ...
		 Name = PoolName](FRHICommandListImmediate& RHICmdList)
	{
		...
		RHI_BREADCRUMB_EVENT_STAT(RHICmdList, VoxelStreamPoolUpload, "VoxelStreamPoolUpload");
