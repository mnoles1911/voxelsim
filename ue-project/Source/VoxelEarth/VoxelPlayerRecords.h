...
VOXELEARTH_API APawn* ActivePawn(UWorld* World,const FGuid& Player);
...
VOXELEARTH_API void VehicleDestroyed(UWorld* World,const FGuid& Vehicle,const FVector& Position);
