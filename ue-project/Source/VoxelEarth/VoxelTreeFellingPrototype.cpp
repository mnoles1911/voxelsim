...
namespace {
FAutoConsoleCommandWithWorld AxeToggle(TEXT("voxel.TreeFelling.Axe"),TEXT("Toggle the prototype stone axe; left click swings."),FConsoleCommandWithWorldDelegate::CreateLambda([](UWorld* W){for(TActorIterator<AV