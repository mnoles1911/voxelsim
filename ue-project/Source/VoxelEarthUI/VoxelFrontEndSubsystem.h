...
private:
	...
	// The fourth theatre cap (2026-09-10): voxel.Stream.RecomputeBudgetMs. Own
	// flag, same reason as the other three.
	bool bRecomputeBudgetCapped = false;
	float SavedRecomputeBudgetMs = 0.f;
