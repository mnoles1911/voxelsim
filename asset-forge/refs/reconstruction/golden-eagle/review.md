...
Perch and fused feet replaced. Retained white wing/tail patches are interpreted as immature plumage; reconstructed feet are not scan measurements.

Biological reference: [Golden eagle species account](https://www.allaboutbirds.org/guide/Golden_Eagle/id). This constrains visual plausibility; it is not a measured registration of the source mesh. See attribution.json for the mesh license and modifications.
